...
public final class Fixture {
    ...
    public static final class CastMembers {
        ...
        private static final CastMember GUILHERME =
                CastMember.newMember("Guilherme", CastMemberType.ACTOR);

        private static final CastMember JOSE =
                CastMember.newMember("Jose", CastMemberType.ACTOR);
        ...
        public static CastMember wesley() {
            return CastMember.with(GUILHERME);
        }

        public static CastMember gabriel() {
            return CastMember.with(JOSE);
        }
    }
